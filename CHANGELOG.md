...
- Install now starts from a macOS-shipped shell path, provisions Homebrew Python when the default `python3` is too old, and then hands off to the managed Python implementation
