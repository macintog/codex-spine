...
def managed_links() -> list[ManagedLink]:
    return [
        ...
        ManagedLink(HOME / ".codex/skills/prose-quality", REPO_ROOT / "skills" / "prose-quality"),
        ManagedLink(HOME / ".codex/skills/performance-tradeoff", REPO_ROOT / "skills" / "performance-tradeoff"),
        ...
        ManagedLink(HOME / ".local/bin/codex-task-temp", REPO_ROOT / "bin/codex-task-temp"),
